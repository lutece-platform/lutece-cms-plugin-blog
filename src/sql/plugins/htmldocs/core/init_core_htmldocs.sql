...
INSERT INTO core_portlet_type (id_portlet_type,name,url_creation,url_update,home_class,plugin_name,url_docreate,create_script,create_specific,create_specific_form,url_domodify,modify_script,modify_specific,modify_specific_form) VALUES ('HTMLDOCSLIST_PORTLET','htmldocs.portlet.htmldocsListHtmldocsPortlet.name','plugins/htmldocs/CreatePortletHtmldocsList.jsp','plugins/htmldocs/ModifyPortletHtmldocsList.jsp','fr.paris.lutece.plugins.htmldocs.business.portlet.HtmlDocsListPortletHome','htmldocs','plugins/htmldocs/DoCreatePortletHtmldocsList.jsp','/admin/portlet/script_create_portlet.html','/admin/plugins/htmldocs/portlet/create_portlethtmldocslist.html','','plugins/htmldocs/DoModifyPortletHtmldocsList.jsp','/admin/portlet/script_modify_portlet.html','/admin/plugins/htmldocs/portlet/modify_portlethtmldocslist.html','');
