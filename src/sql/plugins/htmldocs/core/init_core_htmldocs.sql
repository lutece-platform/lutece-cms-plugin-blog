...
('HTMLDOCS_MANAGEMENT','htmldocs.adminFeature.ManageHtmldocs.name',1,'jsp/admin/plugins/htmldocs/ManageHtmlDocs.jsp','htmldocs.adminFeature.ManageHtmldocs.description',0,'htmldocs',NULL,NULL,NULL,4);
