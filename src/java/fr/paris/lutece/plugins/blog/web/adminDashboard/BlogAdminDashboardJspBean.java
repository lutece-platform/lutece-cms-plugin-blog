   ...
   @Action( ACTION_UPDATE_MANDATORY_TAG_NUMBER )
    ...
    public String getDashboardPage( HttpServletRequest request )throws AccessDeniedException
    {
        ...
        if ( !adminUser.checkRight( RIGHT_AVANCED_CONFIGURATION ) )
        {
            ...
            return AppPathService.getBaseUrl( request ) + DASHBOARD_PAGE + DASHBOARD_PAGE_TAG;
        }
    }
    ...
    public Date formatStringToSqlDate(String strDate)
    {
        ...
        {
            fr.paris.lutece.portal.service.util.AppLogService.error("Error parsing date", e);
        }
        return sqlDate;
    }
}
